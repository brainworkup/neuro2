...
for (config in domain_configs) {
  cat(paste0("Generating files for ", config$domain_name, " (", config$pheno, ")...\n"))
...
tryCatch({
  ...
  generated_file <- processor$generate_domain_qmd(output_file = "_02-09_adhd_adult.qmd")
...
tryCatch({
  ...
  generated_file <- processor$generate_domain_qmd(output_file = "_02-09_adhd_child.qmd", is_child = TRUE)
...
tryCatch({
  ...
  processor$generate_emotion_adult_qmd("Emotional/Behavioral/Personality", "_02-10_emotion_adult.qmd")
...
tryCatch({
  ...
  processor$generate_emotion_child_qmd("Behavioral/Emotional/Social", "_02-10_emotion_child.qmd")
...
remaining_domains <- list(
  list(domain = "Adaptive Functioning", pheno = "adaptive", file = "_02-11_adaptive.qmd"),
  list(domain = "Daily Living", pheno = "daily_living", file = "_02-12_daily_living.qmd")
)
