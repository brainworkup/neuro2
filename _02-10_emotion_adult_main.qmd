...
{{< include _02-10_emotion_adult_text_observer.qmd >}}
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [
          Mood/observer Report. observer reports of behavioral and emotional problems in adultren and adolescents.
                  ],
      ),
      placement: none,
      kind: "image",
...
```{=typst}
// Define the title of the domain
#let title = "Emotional/Behavioral/Personality--observer"

// Define the file name of the table
#let file_qtbl = "table_emotion_observer.png"

// Define the file name of the figure
#let file_fig = "fig_emotion_observer.svg"
