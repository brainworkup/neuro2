---
title: "Getting Started with NeurotypR"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with NeurotypR}
...
The `NeurotypR` package provides tools for generating comprehensive neuropsychological reports using Quarto and Typst templates. This vignette demonstrates the basic workflow for creating reports from neuropsychological test data.
...
- View package vignettes: `browseVignettes("NeurotypR")`
