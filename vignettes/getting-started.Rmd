...
The `neuro2` package provides tools for generating comprehensive neuropsychological reports using Quarto and Typst templates.
This vignette demonstrates the basic workflow for creating reports from neuropsychological test data.
...
The package accepts neuropsychological data in CSV or RDA format.
Your data should include test results organized by cognitive domains.
