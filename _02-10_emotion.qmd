...
if (exists(plot_title_var)) {
  ...
  plot_title_emotion <- "This section presents results from the Behavioral/Emotional/Social domain assessment."
}
```
...
#let title = "Behavioral/Emotional/Social--Self"
...
```{=typst}
// Define the title of the domain
#let title = "Behavioral/Emotional/Social--Parent"
...
```{=typst}
// Define the title of the domain
#let title = "Behavioral/Emotional/Social--Teacher"
