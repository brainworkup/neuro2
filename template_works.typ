...
== Reason for Referral
<reason-for-referral>
Biggie Smalls is a 18-year-old, rightright-handed research assistant with 12 years years of education, including a B.A.
in Hustling from the University of Bed-Sty. He was referred in order to determine the nature and extent of
...
Biggie was born full-term with no reported complications during pregnancy or delivery. His early development included
some notable features: bed-wetting beyond typical age (with no identified medical cause), difficulties with frustration
tolerance when learning new physical skills, and early motor coordination issues described as appearing "a bit floppy
when he ran or was active," which reportedly improved during his high school years.

His medical history includes mild asthma (more significant in childhood), an appendectomy, allergy to Mesquite trees,
and vision impairment for which he was prescribed contacts but does not wear them. Biggie experienced a fever above 104°
at age 13. He was diagnosed with ADHD in elementary school and prescribed medication, which he refused due to disliking
"the feeling." He is currently unmedicated and has no history of psychological counseling or psychiatric evaluation.
Biggie is right-handed for all activities and typically visits a physician approximately twice yearly, with his last
medical visit approximately one year ago.

=== Behavioral/Emotional/Social
<behavioralemotionalsocial>
Biggie is described as having "a big heart," being "fun to be with," and "very social." He demonstrates leadership
qualities in peer group interactions but exhibits significant behavioral challenges, including reactive anger when
challenged or insulted and a history of fighting when provoked. According to reports, "Most of the time, it is not he
who causes the issue, but he is quick to fight if challenged." He associates with peers who reportedly use illegal drugs
and alcohol.

Behaviorally, Biggie exhibits overstimulation in play, a short attention span consistent with his ADHD diagnosis, and
emotional withholding (difficulty expressing affection and feelings). His interests center around football, boxing, and
video games, particularly online gaming with friends. There has been no recent decline in his participation in preferred
activities.

=== Family History
<family-history>
Biggie currently resides with his father in an apartment, where he has lived for the past 1.5 years. His parents
separated when he was an infant. His mother, NAME, is unemployed with some college education. His father, NAME, is a
self-employed executive who completed 11th grade. Biggie has no siblings.

While reportedly closer to his father, Biggie "has a good relationship with mom too." The father serves as the primary
disciplinarian with a "more strict" approach, while the mother maintains "more of a friend style relationship."
Discipline techniques include grounding and suspension of preferred activities, though Biggie "tends to listen with an
attitude." Family activities include sports, conversations, and trips, with English as the primary language spoken at
home. He sees his grandparents only a "Few Times a Year."

Significant family health history includes the father's intermittent stress-related hypertension and the mother's
"problem with alcohol." Notably, both parents had ADHD, with the mother having taken Ritalin during her school years,
suggesting a strong genetic component to Biggie's own ADHD diagnosis.

=== Educational History
<educational-history>
Biggie is currently in 10th grade at Home School, having transitioned from NAME High School by choice in 2024. His
academic performance has improved in the homeschool setting, where he now earns mostly B's with one A. His educational
history includes grade retention in elementary school and consistently performing below grade level on academic testing.

He has demonstrated specific difficulties with mathematics, described as being unable to "comprehend complicated, long
math problems" and having "a hard time retaining information." Biggie has been evaluated for special education annually
since 5th grade and currently has an active Individualized Education Program (IEP) with an ADHD diagnosis. His
homeschool curriculum includes adaptations such as "business math instead of algebra." His anticipated graduation is
in 2027.

While the father reports satisfaction with the current educational arrangement, he expresses concern about the lack of
opportunity for school sports participation, which he believes "would have been very good for him" and might have
prevented Biggie from associating with "kids that were trouble and not athletes."
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [Premorbid Ability is an estimate of an individual's intellectual functioning prior to known or suspected onset
          of brain disease or dysfunction. General Ability is the overall skill to reason, solve problems, and gain
          useful knowledge. Crystallized Knowledge involves understanding the world through language and reasoning.
          Fluid Reasoning is the logical analysis and solution of new problems, identifying underlying patterns, and
          applying logic.],
      ),
      placement: none,
      kind: "image",
...
#let domain(title: none, file_qtbl, file_fig) = {
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [Reading, writing, and math are the three main academic skills assessed Reading ability consists of three
          interrelated abilities: decoding, comprehension, and fluency. Writing ability can be described in terms of
          spelling, grammar, expression of ideas, and writing fluency. Math ability can be described in terms of
          calculation skills, applied problem solving, and math fluency.],
      ),
      placement: none,
      kind: "image",
      supplement: [*Figure*],
...
== Verbal/Language
<sec-verbal>
No data available for Verbal/Language .
...
#let domain(title: none, file_qtbl, file_fig) = {
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [Verbal and language functioning refers to the ability to access and apply acquired word knowledge, to verbalize
          meaningful concepts, to understand complex multistep instructions, to think about verbal information, and to
          express oneself using words.],
      ),
      placement: none,
      kind: "image",
      supplement: [*Figure*],
...
<sec-spatial>
No data available for Visual Perception/Construction .
...
#let domain(title: none, file_qtbl, file_fig) = {
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [Perception, construction, and visuospatial processing refer to abilities such as mentally visualizing how
          objects should look from different angles, visualizing how to put objects together so that they fit correctly,
          and being able to accurately and efficiently copy and/or reproduce visual-spatial information onto paper.],
      ),
      placement: none,
      kind: "image",
      supplement: [*Figure*],
...
#let domain(title: none, file_qtbl, file_fig) = {
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [Learning and memory refer to the rate and ease with which new information (e.g., facts, stories, lists, faces,
          names) can be encoded, stored, and later recalled from long-term memory.],
      ),
      placement: none,
      kind: "image",
      supplement: [*Figure*],
...
#let domain(title: none, file_qtbl, file_fig) = {
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [Attentional and executive functions underlie most, if not all, domains of cognitive performance. These are
          behaviors and skills that allow individuals to successfully carry-out instrumental and social activities,
          academic work, engage with others effectively, problem solve, and successfully interact with the environment
          to get needs met.],
      ),
      placement: none,
      kind: "image",
...
#let domain(title: none, file_qtbl, file_fig) = {
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [Sensorimotor tasks refer to the capacity to control hand movements quickly, smoothly, and with adequate
          precision, which are required to engage in activities such as writing and drawing.],
      ),
      placement: none,
      kind: "image",
      supplement: [*Figure*],
...
=== SELF-REPORT
<self-report-1>
Ethan's parent reported Rule-breaking behavior was Above Average. Ethan's parent reported Demonstration of clear,
logical thought patterns and a general awareness of surroundings was Above Average. Ethan's parent reported Behavioral
symptoms index composite scale was Above Average. Ethan's parent reported Maintain necessary levels of attention was
Above Average. Ethan's parent reported Externalizing problems composite scale was Above Average. Ethan's parent reported
Avoid social situations and appears to be capable of developing and maintaining friendships with others was Above
Average. Ethan's parent reported Ratings of aggressive behavior and to act aggressively was High Average. Ethan's parent
reported Tendency to be overly active, rush through work or activities, and act without thinking was High Average.
Ethan's parent reported Excessive feelings of unhappiness, sadness, or stress was High Average. Ethan's score on
Grandiosity (person may have little capacity to recognize personal limitations, to the point where one is not able to
think clearly about one's capabilities) was High Average. Ethan's score on Obsessive-Compulsive (scores marked rigidity
and significant ruminative concerns) was Average. Ethan's score on Antisocial Behaviors (scores suggest a history of
difficulties with authority and with social convention) was Average. Ethan's score on Egocentricity (suggest a person
who tends to be self-centered and pragmatic in interaction with others) was Average. Ethan's score on Alcohol Problems
(are indicative of an individual who may drink regularly and may have experienced some adverse consequences as a result)
was Average. Ethan's score on Drug Problems (scores are indicative of a person who may use drugs on a fairly regular
basis and may have experienced some adverse consequences as a result) was Average. Ethan's score on Warmth (average
...
score on Antisocial Features (individuals are likely to be impulsive and hostile, perhaps with a history of reckless
and/or antisocial acts) was Average. Ethan's score on Anxiety-Related Disorders (reflecting multiple anxiety-disorder
diagnoses and broad impairment associated with anxiety) was Average. Ethan's score on Negative Relationships (person is
likely to be bitter and resentful about the way past relationships have gone) was Average. Ethan's score on Treatment
Rejection (average scores suggest a person who acknowledges major difficulties in their functioning, and perceives an
acute need for help in dealing with these problems) was Average. Ethan's parent reported Internalizing problems
composite scale was Average. Ethan's score on Traumatic Stress (trauma (single or multiple) is the overriding focus of
the person's life) was Average. Ethan's score on Affective (D) (elevations suggest sadness, a loss of interest in normal
activities and a loss if one's sense of pleasure in things that were previously enjoyed) was Average. Ethan's score on
Physical Aggression (suggest that losses of temper are more common and that the person is prone to more physical
displays of anger, perhaps breaking objects or engaging in physical confrontations) was Average. Ethan's score on
Dominance (average scores reflect an individual who is likely to be able to adapt to different interpersonal situations,
by being able to both take and relinquish control in these relationships as needed) was Average. Ethan's score on
Persecution (suggest an individual who is quick to feel that they are being treated inequitably and easily believes that
there is concerted effort among others to undermine their best interests) was Average. Ethan's score on Stimulus-Seeking
(patient is likely to manifest behavior that is reckless and potentially dangerous to himself and/or those around him)
was Average. Ethan's score on Phobias (indicate impairing phobic behaviors, with avoidance of the feared object or
situation) was Average. Ethan's parent reported Able to adequately perform simple daily tasks in a safe and efficient
manner was Average. Ethan's parent reported Tendency to be nervous, fearful, or worried about real or imagined problems
was Average. Ethan's score on Mania (scores are associated with disorders such as mania, hypomania, or cyclothymia) was
Average. Ethan's score on Self-Harm (reflect levels of impulsivity and recklessness that become more hazardous as scores
rise) was Average. Ethan's score on Verbal Aggression (reflects a person who is assertive and not intimidated by
confrontation and, toward the upper end of this range, he may be verbally aggressive) was Average.
...
#let domain(title: none, file_qtbl, file_fig) = {
  ...
  grid(
    ...
    figure(
      ...
      caption: figure.caption(
        position: bottom,
        [Mood/Behavioral Reports. Self-, parent-, and teacher-reports of behavioral, emotional, and social
          difficulties.],
      ),
      placement: none,
      kind: "image",
...
(are indicative of an individual who may drink regularly and may have experienced some adverse consequences as a result)
was Average. Ethan's score on Drug Problems (scores are indicative of a person who may use drugs on a fairly regular
basis and may have experienced some adverse consequences as a result) was Average.
...
#let domain(file_fig) = {
  ...
  figure(
    ...
    caption: figure.caption(
      position: bottom,
      [Overall neurocognitive function subdomain plots of the patient's strengths and weaknesses. _Note:_ _z_-scores
...
#let three-line-table = tablem.with(
  render: (columns: auto, ..args) => {
    table(
      ...
      align: (col, row) => if row == 0 { center + horizon } else if col == 0 { left + horizon } else {
        center + horizon
      },
      table.hline(y: 0),
      table.hline(y: 1),
