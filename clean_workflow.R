...
domains <- list(
  list(key = "iq", name = "General Cognitive Ability", data = "neurocog", num = "01"),
  list(key = "academics", name = "Academic Skills", data = "neurocog", num = "02"),
  list(key = "verbal", name = "Verbal/Language", data = "neurocog", num = "03"),
  list(key = "spatial", name = "Visual Perception/Construction", data = "neurocog", num = "04"),
  list(key = "memory", name = "Memory", data = "neurocog", num = "05"),
  list(key = "executive", name = "Attention/Executive", data = "neurocog", num = "06"),
  list(key = "motor", name = "Motor", data = "neurocog", num = "07"),
  list(key = "social", name = "Social Cognition", data = "neurocog", num = "08"),
  list(key = "emotion", name = "Behavioral/Emotional/Social", data = "neurobehav", num = "10"),
  list(key = "validity", name = "Performance Validity", data = "neurocog", num = "13")
)
...
'
  ...
  for (p in processed) {
    ...
    qmd_file <- paste0("_02-", d$num, "_", d$key, ".qmd")
    if (file.exists(qmd_file)) {
      template_content <- paste0(template_content, "{{< include ", qmd_file, " >}}\n\n")
    }
  }
