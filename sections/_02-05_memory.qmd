## Memory {#sec--02-05-memory}

{{< include _02-05_memory_text.qmd >}}

```{r}
#| label: setup--02-05-memory
#| include: false
...
# Filter by scales
scales <- c("Memory Index (MEM)", "List Learning", "Story Learning", "Figure Learning")
...
```{r}
#| label: table--02-05-memory
#| tbl-cap: "Memory Test Scores"
...
```{r}
#| label: fig--02-05-memory-subdomain
#| fig-cap: "Memory subdomain scores"
#| fig-height: 4
#| fig-width: 6
