...
academics <- readr::read_csv(here::here("data", "neurocog.csv"))
```
...
# Read the data using the read_data function from the NeurotypR library
...
data_academics <- NeurotypR::filter_data(data, domain = domains, scale = scales)
```
...
# Create the table using NeurotypR::tbl_gt
NeurotypR::tbl_gt(
  data = data_academics,
  pheno = pheno,
  table_name = table_name,
  source_note = fn_standard_score, # Use standard score as source note
