...
scale_var_name <- "scales_academics"
...
file.create("_02-02_academics_text.qmd")
...
if ("z_mean_subdomain" %in% names(data_academics) && "subdomain" %in% names(data_academics)) {
...
if (exists(plot_title_var)) {
  ...
  plot_title_academics <- "Academic Skills scores ... "
}
```
...
if ("z_mean_narrow" %in% names(data_academics) && "narrow" %in% names(data_academics)) {
