...
file.create("_02-05_memory_text.qmd")
...
if ("z_mean_subdomain" %in% names(data_memory) && "subdomain" %in% names(data_memory)) {
...
if ("z_mean_narrow" %in% names(data_memory) && "narrow" %in% names(data_memory)) {
