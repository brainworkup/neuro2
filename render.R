...
thumbify <- function(ext, rendered, thumbnail_name) {
  ...
  if (ext %in% c("docx", "odt")) {
    ...
    to_convert <- paste0(
      outdir_temp,
      "/",
      tools::file_path_sans_ext(basename(rendered)),
      ".pdf"
    )
  } else {
