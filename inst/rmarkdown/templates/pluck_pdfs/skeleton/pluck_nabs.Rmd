...
table1 <-
  ...
  dplyr::mutate(
    subdomain = dplyr::case_when(
      ...
      scale == "NAB Executive Functions Index" ~ "Executive",
      scale == "NAB Total Index" ~ "Neurocognition",
...
table6 <-
  ...
  dplyr::mutate(
    subdomain = dplyr::case_when(
      scale == "Mazes" ~ "Executive",
      scale == "Word Generation" ~ "Executive",
...
table1 <-
  ...
  dplyr::mutate(
    narrow = dplyr::case_when(
      ...
      scale == "NAB Executive Functions Index" ~ "Executive Index",
...
readr::write_excel_csv(
  nabs,
  here::here("data-raw", "csv", "nabs.csv"),
  col_names = TRUE,
  na = ""
)
