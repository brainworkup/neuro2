...
table8 <- NeurotypR::gpluck_make_columns(
  table8,
  test = params$test,
  test_name = params$test_name,
  ci_95 = "",
...
table9 <- NeurotypR::gpluck_make_columns(
  table9,
  test = params$test,
  test_name = params$test_name,
  ci_95 = "",
...
for (i in seq_along(tables)) {
  tables[[i]] <- NeurotypR::gpluck_make_score_ranges(table = tables[[i]], test_type = "npsych_test")
}
