...
# to_double <- c("raw_score", "score", "percentile")
# table2 <- table2 <- convert_columns(table2, c(), to_double, c())
# table2[, 1] <- (params$table2)
# table2 <- table2 |> dplyr::select(all_of(params$keep2))
```
...
table2 <- NeurotypR::gpluck_make_score_ranges(
  table = table2,
  test_type = "npsych_test"
)
```
...
to_double <- c("raw_score", "score", "percentile")
table4 <- table4 <- convert_columns(table4, c(), to_double, c())
...
to_double <- c("raw_score", "score", "percentile")
table5 <- table5 <- convert_columns(table5, c(), to_double, c())
...
to_double <- c("raw_score", "score", "percentile")
table6 <- table6 <- convert_columns(table6, c(), to_double, c())
...
to_double <- c("raw_score", "score", "percentile")
table7 <- table7 <- convert_columns(table7, c(), to_double, c())
