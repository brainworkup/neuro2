...
```{r}
# input_file_path <- "data-raw/004004907_3_10_2024.csv"
# test_name_prefix <- "RBANS Update Form A "
...
rbans <-
  ...
  dplyr::mutate(
    domain = dplyr::case_when(
      ...
      is.character(scale) & scale == "RBANS RBANS Digit Span" ~ "Attention/Executive",
      is.character(scale) & scale == "RBANS RBANS Coding" ~ "Attention/Executive",
...
rbans <-
  ...
  dplyr::mutate(
    subdomain = dplyr::case_when(
      is.character(scale) & scale == "RBANS Total Index" ~ "Neurocognitive Index",
      ...
      is.character(scale) & scale == "RBANS Digit Span" ~ "Attention",
      is.character(scale) & scale == "RBANS Coding" ~ "Processing Speed",
...
rbans <-
  ...
  dplyr::mutate(
    narrow = case_when(
      ...
      is.character(scale) & scale == "RBANS Digit Span" ~ "Attention Span",
      is.character(scale) & scale == "RBANS Coding" ~ "Cognitive Efficiency",
...
rbans <-
  ...
  dplyr::mutate(
    timed = case_when(
      ...
      is.character(scale) & scale == "RBANS Digit Span" ~ "Untimed",
      is.character(scale) & scale == "RBANS Coding" ~ "Timed",
...
rbans <-
  ...
  dplyr::mutate(
    verbal = case_when(
      ...
      is.character(scale) & scale == "Attention Index" ~ "",
      is.character(scale) & scale == "RBANS Digit Span" ~ "Verbal",
      is.character(scale) & scale == "RBANS Coding" ~ "Nonverbal",
...
rbans <-
  ...
  dplyr::mutate(
    pass = case_when(
      ...
      is.character(scale) & scale == "RBANS Digit Span" ~ "Attention",
      is.character(scale) & scale == "RBANS Coding" ~ "Planning",
      is.character(scale) & scale == "Delayed Memory Index" ~ "",
...
rbans <-
  ...
  dplyr::mutate(
    score_type = case_when(
      ...
      is.character(scale) & scale == "RBANS Digit Span" ~ "scaled_score",
      is.character(scale) & scale == "RBANS Coding" ~ "scaled_score",
...
rbans <-
  ...
  dplyr::mutate(
    description = case_when(
      ...
      is.character(scale) & scale == "RBANS Digit Span" ~ "attention span and auditory attention",
      is.character(scale) & scale == "RBANS Coding" ~ "speed of information processing",
      is.character(scale) & scale == "Delayed Memory Index" ~
