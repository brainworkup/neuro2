...
# Test score ranges
table1 <- NeurotypR::gpluck_make_score_ranges(
  table = table1,
  test_type = "npsych_test"
)
```
...
# Test score ranges
table3 <- NeurotypR::gpluck_make_score_ranges(
  table = table3,
  test_type = "npsych_test"
)
```
...
```{r}
table4 <- NeurotypR::gpluck_compute_percentile_range(
  .x = table4,
  .score = table4$score,
  .score_type = "scaled_score"
)
...
```{r}
table4 <- NeurotypR::gpluck_make_score_ranges(
  table = table4,
  test_type = "npsych_test"
)
```
