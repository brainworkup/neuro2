...
```{r}
file_path <- file.path(here::here("data-raw", "pdf", "pai_adol.pdf"))
...
saveRDS(file, "pai_adol.rds")
# file <- readRDS("pai_adol.rds")
```
...
plucked_tables <-
  readr::read_csv(
    here::here("data", "pariconnectexportPAI-A.csv")
  )
```
...
```{r ranges}
df_clinical <- gpluck_make_score_ranges(
  table = df_clinical,
  test_type = "rating_scale"
)
df_validity <- gpluck_make_score_ranges(
  table = df_validity,
  test_type = "symptom_validity"
)
```
...
df_clinical <-
  ...
  dplyr::mutate(
    domain = dplyr::case_when(
      scale == "Somatic Complaints" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Conversion" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Somatization" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Health Concerns" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Anxiety" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Cognitive (A)" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Affective (A)" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Physiological (A)" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Anxiety-Related Disorders" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Obsessive-Compulsive" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Phobias" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Traumatic Stress" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Depression" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Cognitive (D)" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Affective (D)" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Physiological (D)" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Mania" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Activity Level" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Grandiosity" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Irritability" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Paranoia" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Hypervigilance" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Persecution" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Resentment" ~ "Emotional/Behavioral/Social/Personality",
      scale == "Schizophrenia" ~ "Emotional/Behavioral/Social/Personality",
...
# readr::write_csv(
#   pai,
#   here::here("data-csv", "csv", "pai_adol.csv"),
#   col_names = TRUE,
#   na = ""
# )
...
readr::write_excel_csv(
  df_clinical,
  here::here("data-csv", "csv", "pai_a_clinical.csv"),
  col_names = TRUE,
  na = ""
)
...
readr::write_excel_csv(
  df_validity,
  here::here("data", "csv", "pai_a_validity.csv"),
  col_names = TRUE,
  na = ""
)
```
...
# save
readr::write_lines(pai_text_squished, here::here("pai_a_text_squished.md"), sep = "\n")
readr::write_lines(pai_text_squished, here::here("pai_a_text_squished.txt"), sep = "\n")
```
