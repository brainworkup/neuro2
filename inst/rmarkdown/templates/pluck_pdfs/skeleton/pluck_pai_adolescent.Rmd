...
saveRDS(file_path, "pai_adol.rds")
...
```{r}
plucked_tables <- readr::read_csv(here::here(
  "data-raw",
...
df_clinical <- df_clinical_mutated |> dplyr::slice(slice_clinical)
slice_validity <- c(1:4)
df_validity <- df_validity_mutated |> dplyr::slice(slice_validity)
```
...
readr::write_excel_csv(
  df_clinical,
  here::here("data-raw", "csv", "pai_adol_clinical.csv"),
  col_names = TRUE,
  na = ""
)
...
readr::write_excel_csv(
  df_validity,
  here::here("data-raw", "csv", "pai_adol_validity.csv"),
  col_names = TRUE,
  na = ""
)
```
...
readr::write_lines(
  pai_adol_text_squished,
  here::here("pai_adol_text_squished.md"),
  sep = "\n"
)
readr::write_lines(
  pai_adol_text_squished,
  here::here("pai_adol_text_squished.txt"),
  sep = "\n"
)
```
