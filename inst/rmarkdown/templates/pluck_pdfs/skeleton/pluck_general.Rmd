...
```{r eval = TRUE}
# pdf <- file.path("/Users/joey/reports/Biggie/pdf/Biggie_adhd_ld_battery-2a4e56ea-524d-496f-a277-5d4f356a60ca.pdf")
...
extracted_tables <- NeurotypR::gpluck_extract_table(
  file = file,
  pages = pages,
  area = area,
  guess = "FALSE",
