...
g <- readxl::read_excel("data-raw/index_scores.xlsx") |>
  ...
  gpluck_make_score_ranges(range = "", test_type = "npsych_test") |>
  dplyr::select(
    test,
    test_name,
    scale,
...
# save g.csv
readr::write_csv(g, "data-raw/g.csv")
```
...
g <- readr::read_csv("data-raw/g.csv")
...
# Create a DotplotR6 object
dotplot_obj <- neuro2::DotplotR6$new(
  data = g,
  x = x,
  y = y,
  colors = colors,
