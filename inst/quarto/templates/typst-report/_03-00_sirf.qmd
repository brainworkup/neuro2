...
if ("neuro2" %in% rownames(installed.packages())) {
  ...
  # When running from development, find the R directory
  r_dir <- if (dir.exists("R")) {
    "R"
  } else if (dir.exists("../../../R")) {
    "../../../R"  # From inst/quarto/templates/typst-report/
  } else if (dir.exists("../../../../R")) {
    "../../../../R"  # Alternative path
  } else {
  ...
  # Source R6 classes
  source(file.path(r_dir, "DomainProcessorR6.R"))
  source(file.path(r_dir, "ReportTemplateR6.R"))
  source(file.path(r_dir, "NeuropsychReportSystemR6.R"))
  source(file.path(r_dir, "DotplotR6.R"))
}
