...
```{r}
#| label: generate-all-figures
#| include: false
#| echo: false

# This chunk runs first and generates all needed figures
# without rendering the domain files to Typst

source("generate_all_domain_assets.R")
# This script should generate your .svg and .png files
# without rendering the .qmd files to Typst
```
