...
format: 
  neurotyp-pdf:
    pdf-engine: typst
    output-file: '{uuid()}.pdf'
---

{{< include /Users/joey/neuro2/inst/quarto/templates/typst-report/_environment.qmd >}}

```{r}
#| label: load-packages
#| include: false

# Load the neuro2 package instead of sourcing individual files
library(neuro2)
