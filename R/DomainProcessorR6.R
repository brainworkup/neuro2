...
") {\n",
"  data_subdomain <- data_emotion_self[!is.na(data_emotion_self$z_mean_subdomain) & !is.na(data_emotion_self$subdomain), ]\n",
"  if (nrow(data_subdomain) > 0) {\n",
"    fig_path <- here::here(\"figs\", \"fig_emotion_child_self_subdomain\")\n",
"    dotplot_subdomain <- DotplotR6$new(\n",
"      data = data_subdomain,\n",
"      x = \"z_mean_subdomain\",\n",
"      y = \"subdomain\"\n",
...
") {\n",
"  data_subdomain <- data_emotion_parent[!is.na(data_emotion_parent$z_mean_subdomain) & !is.na(data_emotion_parent$subdomain), ]\n",
"  if (nrow(data_subdomain) > 0) {\n",
"    fig_path <- here::here(\"figs\", \"fig_emotion_child_parent_subdomain\")\n",
"    dotplot_subdomain <- DotplotR6$new(\n",
"      data = data_subdomain,\n",
"      x = \"z_mean_subdomain\",\n",
"      y = \"subdomain\"\n",
...
") {\n",
"  data_subdomain <- data_emotion_teacher[!is.na(data_emotion_teacher$z_mean_subdomain) & !is.na(data_emotion_teacher$subdomain), ]\n",
"  if (nrow(data_subdomain) > 0) {\n",
"    fig_path <- here::here(\"figs\", \"fig_emotion_child_teacher_subdomain\")\n",
"    dotplot_subdomain <- DotplotR6$new(\n",
"      data = data_subdomain,\n",
"      x = \"z_mean_subdomain\",\n",
"      y = \"subdomain\"\n",
...
"}\n\n",
      ...
      qmd_content <- paste0(
        ...
        "// Define the file name of the figure\n",
        "#let file_fig = \"figs/fig_emotion_child_self_subdomain.svg\"\n\n",
        "// The title is appended with ' Scores'\n",
        "// #domain(title: [#title Scores], file_qtbl, file_fig)\n",
        "```\n\n",
        "### PARENT RATINGS\n\n",
        ...
        "// Define the file name of the figure\n",
        "#let file_fig = \"figs/fig_emotion_child_parent_subdomain.svg\"\n\n",
        "// The title is appended with ' Scores'\n",
        "// #domain(title: [#title Scores], file_qtbl, file_fig)\n",
        "```\n\n",
        "<!-- ### TEACHER RATINGS-->\n\n",
