...
#' Internal neuropsychological test data - Neurocog
#'
#' Internal dataset containing neurocognitive test data used for report generation.
#' This data is not exported and is for internal package use only.
#'
#' @format A data frame with 74 rows and 39 variables containing neurocognitive test results
#' @keywords internal datasets
#' @name neurocog
NULL
