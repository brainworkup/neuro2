...
DomainProcessorR6Combo <- R6::R6Class(
  ...
  public = list(
    ...
    generate_standard_qmd = function(domain_name, output_file) {
      ...
      text_file <- paste0("_02-", self$number, "_", tolower(self$pheno), "_text.qmd")
      ...
      qmd_content <- paste0(
        ...
        "# Create R6 processor\n",
        "processor_", tolower(self$pheno), " <- DomainProcessorR6Combo$new(\n",
        "  domains = domains,\n",
        "  pheno = pheno,\n",
        ...
        "if (\"z_mean_subdomain\" %in% names(data_", tolower(self$pheno), ") && \"subdomain\" %in% names(data_", tolower(self$pheno), ")) {\n",
        ...
        "if (\"z_mean_narrow\" %in% names(data_", tolower(self$pheno), ") && \"narrow\" %in% names(data_", tolower(self$pheno), ")) {\n",
      ...
      message(paste("Generated standard QMD file following memory template:", output_file))
      return(output_file)
    },
