...
```{r}
#| label: qtbl-adhd-child-self
#| include: false
#| eval: true

# Table parameters
table_name <- "table_adhd_child_self"
vertical_padding <- 0
multiline <- TRUE
...
```{r}
#| label: qtbl-adhd-child-parent
#| include: false
#| eval: true

# Table parameters
table_name <- "table_adhd_child_parent"
vertical_padding <- 0
multiline <- TRUE
...
```{r}
#| label: qtbl-adhd-child-teacher
#| include: false
#| eval: true

# Table parameters
table_name <- "table_adhd_child_teacher"
vertical_padding <- 0
multiline <- TRUE
...
```{r}
#| label: fig-adhd-child-self-subdomain
#| include: false
#| eval: true
...
dotplot_subdomain <- DotplotR6$new(
  ...
  x = "z_mean_subdomain",
  y = "subdomain",
  filename = "fig_adhd_child_self_subdomain.svg"
)
dotplot_subdomain$create_plot()
```

```{r}
#| label: fig-adhd-child-parent-subdomain
#| include: false
#| eval: true
...
dotplot_subdomain <- DotplotR6$new(
  ...
  x = "z_mean_subdomain",
  y = "subdomain",
  filename = "fig_adhd_child_parent_subdomain.svg"
)
dotplot_subdomain$create_plot()
```

```{r}
#| label: fig-adhd-child-teacher-subdomain
#| include: false
#| eval: true
...
dotplot_subdomain <- DotplotR6$new(
  ...
  x = "z_mean_subdomain",
  y = "subdomain",
  filename = "fig_adhd_child_teacher_subdomain.svg"
)
dotplot_subdomain$create_plot()
```
