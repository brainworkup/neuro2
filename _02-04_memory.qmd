...
{{< include _02-04_memory_text.qmd >}}
...
domain_data <- neurocog %>%
  filter(domain == domain_name |
         scale %in% c("Memory Index (MEM)", "NAB Memory Index", "List Learning", "Story Learning", "Figure Learning", "Immediate Recall", "Delayed Recall", "Recognition Memory"))
```
