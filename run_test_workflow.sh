...
echo "   - verbal.csv, memory.csv, executive.csv (domain-specific data)"
echo ""
echo "2. Generated domain files:"
echo "   - _02-03_verbal.qmd (or similar based on your data)"
echo "   - _02-03_verbal_text.qmd"
echo "   - _02-05_memory.qmd"
echo "   - _02-05_memory_text.qmd"
echo "   - _02-06_executive.qmd"
echo "   - _02-06_executive_text.qmd"
echo ""
echo "3. Generated visualizations:"
echo "   - table_verbal_parquet.png/pdf"
echo "   - test_verbal_dotplot.svg"
echo "   - table_memory_parquet.png/pdf"
echo "   - test_memory_dotplot.svg"
echo "   - table_executive_parquet.png/pdf"
echo "   - test_executive_dotplot.svg"
echo ""
