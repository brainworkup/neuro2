# Test script for DomainProcessorR6 emotion domain processing
# Tests both child and adult emotion domains

library(here)
source(here("R/DomainProcessorR6.R"))
...
test_emotion_processing <- function() {
  ...
  mock_data <- data.frame(
    ...
    scale = c("Externalizing", "Internalizing", "Anxious/Depressed", "Attention Problems"),
  ...
  cat("✓ Child rater types correct:", identical(rater_types_child, c("self", "parent", "teacher")), "\n")
  cat("✓ Adult emotion domain detection:", emotion_type_adult == "adult", "\n")
  cat("✓ Adult emotion rater types correct (self only):", identical(rater_types_adult, c("self")), "\n")
  cat("✓ ADHD has multiple raters:", has_multiple, "\n")
  cat("✓ ADHD rater types correct (self & observer):", identical(rater_types_adhd, c("self", "observer")), "\n")
