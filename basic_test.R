...
# Test 3: Check if workflow files exist and can be parsed
workflow_files <- c(
  "neuro2_efficient_workflow.R",
  "01_import_process_data.R",
  "02_create_domain_qmds.R",
  "03_render_domains.R"
)

r6_workflow_files <- c(
  "neuro2_r6_workflow.R",
  "neuro2_r6_update_workflow.R",
  "test_r6_integration.R"
)
