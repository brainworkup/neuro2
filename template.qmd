...
if (file.exists("R/TableGT.R")) {
  ...
  # Create a global wrapper function for tbl_gt2 if it doesn't exist in NeurotypR namespace
  if (!exists("tbl_gt2", where = asNamespace("NeurotypR"))) {
    message("Creating global tbl_gt2 wrapper function")
    # This makes the tbl_gt2 function available globally
