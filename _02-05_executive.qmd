...
domain_data <- neurocog %>%
  filter(domain == domain_name | 
         scale %in% c("Attention Index (ATT)", "Executive Functions Index (EXE)", "NAB Attention Index", "NAB Executive Functions Index", "Digits Forward", "Digits Backward", "Coding", "Symbol Search", "Mazes", "Categories", "Word Generation"))
```

```{r}
#| label: table-executive
#| echo: false
