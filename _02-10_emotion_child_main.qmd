## Psychosocial Problems {#sec-emotion-child}
...
if (exists(plot_title_var)) {
  ...
  plot_title_emotion_child_self <- "This section presents results from the Psychosocial Problems domain assessment."
}
```
...
if (exists(plot_title_var)) {
  ...
  plot_title_emotion_child_parent <- "This section presents parent-rating results from the Psychosocial Problems domain assessment."
}
```
...
if (exists(plot_title_var)) {
  ...
  plot_title_emotion_child_teacher <- "This section presents teacher-rated results from the Psychosocial Problems domain assessment."
}
```
...
#let title = "Psychosocial Problems"
