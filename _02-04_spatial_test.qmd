...
data_spatial <- filter_data(data = memory, domain = domains, scale = scales)
```
```{r}
#| label: text-spatial
#| cache: true
...
if (exists(plot_title_var)) {
  ...
  plot_title_spatial <- "Visuospatial scores ... "
}
```
